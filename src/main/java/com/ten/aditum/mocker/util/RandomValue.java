...
public class RandomValue {
    ...
    private static final String[] ADDRESS = "北区桃园,北区桂园,北区李园,北区杏园,北区桔园,北区梅园,北区榴园,南区涓苑,南区清苑,南区溪苑,南区澈苑,南区鸿苑,南区润苑,南区浩苑,南区翰苑,南区淳苑".split(",");

    private static int getNum(int start, int end) {
        return (int) (Math.random() * (end - start + 1) + start);
    }

    private static String[] telFirst = "134,135,136,137,138,139,150,151,152,157,158,159,130,131,132,155,156,133,153,188,189,187".split(",");
